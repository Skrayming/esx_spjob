...
Config.PoliceDatabaseName = 'sp'-- set the exact name from your jobs database for police
...
Config.CarGarageDisplay = 2

Config.CarGarageScale = 1.02
...
Config.HeliGarageDisplay = 2

Config.HeliGarageScale = 1.02
...
Config.BoatGarageDisplay = 2

Config.BoatGarageScale = 1.02
...
Config.ExtraGarageDisplay = 2

Config.ExtraGarageScale = 1.02
...
Config.PoliceCarMarker = 32 												-- marker type

Config.PoliceCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			-- rgba color of the marker

Config.PoliceCarMarkerScale = { x = 1.5, y = 1.5, z = 35 }  				-- the scale for the marker on the x, y and z axis
...
Config.PoliceHeliMarker = 32 												-- marker type
...
Config.PoliceBoatMarker = 32 												-- marker type
...
Config.PoliceExtraMarker = 32												-- marker type
...
Config.PoliceVehicles = {
		...
		{ model = '', label = '-----Véhicules-----'},

                { model = 'arsamu', label = 'PSE'},
                { model = 'policeold2', label = 'VLCG'},
                { model = 'arsamu2', label = 'VSAV Renault Master'},
                { model = 'vlddsis', label = 'Clio Chef de groupe'},
                { model = 'ambulance', label = 'VSAV TIB'},
                { model = 'vps', label = 'VPS'},
                { model = 'firetruk', label = 'CCGC'},
                { model = 'fsr33', label = 'FSR'},
                { model = 'ccf', label = 'CCF'},
                { model = 'fpt742', label = 'FPT'},
                { model = 'umd', label = 'VIRT'},
                { model = 'vgr', label = 'VGR'},
                { model = 'vgr2', label = 'Camion GRIMP'},
                { model = 'vgrimp', label = '4X4 GRIMP'},
                { model = 'vlec', label = 'VEC'},
                { model = 'vpl74', label = 'VPL'},
                { model = 'vtu74', label = 'VTU'},
                { model = 'vtu', label = 'VTU 2'},
                { model = 'epan', label = 'EPA'},
                { model = 'vlmi74', label = 'VLMI'}
...
Config.PoliceHelicopters = {
	...
	{ model = 'polmav', label = 'Helicoptere Securité civile', livery = 0, price = 0 },
